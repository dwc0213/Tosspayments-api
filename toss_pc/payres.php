<?php
	...
	$configPath = "/home/leehyunjoo/www/module/toss_pc/lgdacom"; //토스페이먼츠에서 제공한 환경파일("/conf/lgdacom.conf,/conf/mall.conf") 위치 지정. 
...
*/
        ...
        if( "0000" == $xpay->Response_Code() ) {
			...
			$userid = $_POST["userid"];
			$reg_date = $_POST["LGD_OID"];
			$pay_num = $xpay->Response("LGD_TID",0);
			
			

/*
			if (include('success3.php') == TRUE) {
				echo "DB성공!!<br>";
			}
			else
				echo "DB실패 ㅜㅜ<br>";
