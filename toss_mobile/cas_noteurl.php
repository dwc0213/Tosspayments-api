<?php
    ...
    $LGD_TID                 = $_POST["LGD_TID"];                  // 토스페이먼츠에서 부여한 거래번호
	...
	$LGD_MERTKEY = "93200ff88799726d42cee4e94b4a4589";  //토스페이먼츠에서 발급한 상점키로 변경해 주시기 바랍니다.
        ...
        if ( "0000" == $LGD_RESPCODE ){ //결제가 성공이면
        	...
        	if( "R" == $LGD_CASFLAG ) {
            	...
            	//if( 무통장 입금 성공 상점처리결과 성공 ) 
					...
					$sql = "update ks_order set status='입금확인' where userid='$LGD_BUYERID' and reg_date='$LGD_OID'";
					$result = mysql_query($sql);
